...
\chapter*{Disclaimer on GenAI}\label{disclaimer-on-genai}

\markboth{Disclaimer on GenAI}{Disclaimer on GenAI}

During the preparation of this work, the authors used OpenAI GPT-4o for
\emph{grammar and spelling check} and simple rephrasing. After using

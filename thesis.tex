...
This thesis was written in Athens, Greece during the academic year
2024--2025. It is part of the requirements for the Bachelor of Science
program in the \href{https://www.di.uoa.gr/en}{Department of Informatics
and Telecommunications} at the \href{https://en.uoa.gr/}{National and
Kapodistrian University of Athens}. The research was conducted under the
supervision of Prof.~\href{https://cgi.di.uoa.gr/~thanassis/}{Thanassis
Avgerinos}. The completed thesis is also available through the
...
Memory-safe languages, like Ada or Rust
\autocite{adadevelopers2022,rustprojectdevelopers2025}---not absolutely
safe themselves

NASA safety-critical code guidelines \autocite{holzmann2006}

C by Dennis Ritchie in 1972 \autocite{kernighan1978,ritchie1978}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Most automatic fuzzers rely on existings harnesses
      \autocite{oss-fuzz-gen} or preexisting client code
      \autocite{utopia,fuzzgen,fudge}
    \item
  ...
  \item
    ...
    \tightlist
    \item
      We explain its design architecture, the techniques that emerged in
      its development and how they are implemented
    \item
      We construct a dataset of 10 open-source projects and evaluate
      OverHAuL with them
    \item
      We examine the results and try to answer our research questions
    \end{itemize}
  \end{itemize}
\item
  ...
  \item
    Experimental benchmarks show a 92.5\% chance of successful harness
    generation
  \item
    Code and artifacts are available in the project's repo
